...
![Downloads](https://img.shields.io/packagist/dt/ievtds/laravel-firewall)
![Tests](https://img.shields.io/github/actions/workflow/status/ievtds/laravel-firewall/tests.yml?label=tests)
[![StyleCI](https://github.styleci.io/repos/197242392/shield?style=flat&branch=master)](https://styleci.io/repos/197242392)
[![License](https://img.shields.io/github/license/ievtds/laravel-firewall)](LICENSE.md)
...
```bash
composer require ievtds/laravel-firewall
```
...
Please review [our security policy](https://github.com/ievtds/laravel-firewall/security/policy) on how to report security vulnerabilities.
